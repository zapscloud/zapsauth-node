...
module.exports = class Auth {
    ...
    tokenService (req, res) {
        ...
        debug('user id', req.headers, this.zapsurl)
    ...
    accessToken (data) {
        return new Promise((resolve, reject) => {
            axios.post(`https://auth.${this.stage}api.zapscloud.com/token`,data, this.header_param)
    ...
    validateToken(token) {
        return new Promise((resolve, reject) => {
            axios.post(`https://auth.${this.stage}api.zapscloud.com/token/${token}`,'', this.header_param)
                .then(function (response) {
                    return resolve(response.data);
                })
                .catch(function (error) {
